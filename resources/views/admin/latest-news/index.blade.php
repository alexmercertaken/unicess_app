<x-admin-layout>
    ...
    <div class="py-12 px-5 w-full ">
        ...
        <div class=" flex py-5 px-10 justify-between">
            <h1 class="text-2xl" >News Dashboard</h1>
            {{--  Modal Starts here  --}}
            ...
            <div class="fixed inset-0 z-50 flex items-center justify-center overflow-auto bg-black bg-opacity-50" x-show="showModal">
                ...
                >
                    ...
                    <div class="flex items-center justify-between mb-10 ">
                        <h5 class="mr-3 text-black max-w-none">Create news</h5>
                    ...
                    <div class="w-full">
                        ...
                        <div class="justify-center flex">
                            <label for=""></label>
                            <div class="p-2 w-46 items-center ">
                                <img id="showImage" src="{{ asset('upload/no-image.png') }}" alt="">
                            </div>
                        </div>
                    ...
                    <div class="overflow-x-auto sm:-mx-6 lg:-mx-8">
                      <div class="py-2 inline-block min-w-full sm:px-6 lg:px-8">
                        <div class="flex p-2 my-2 justify-between">
                            <h1 class="font-semibold"> News</h1>
                            ...
                            <tbody >
                                ...
                                <tr class="border-b">
                                    ...
                                    <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap w-16">
                                        ...
                                        <img class="rounded-2xl" id="showImage" src="{{ (!empty($newsupdate->image))? url('upload/image-folder/'. $newsupdate->image): url('upload/no-image.png') }}" alt="">
                                    </td>
