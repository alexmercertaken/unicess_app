                ...
                <div class="p-2  flex items-center justify-between">
                    ...
                    <form action="{{route('admin.latest-news.update', $latestNews->id)}}" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="mb-4">
                        ...
                        placeholder="">{{$latestNews->description}}</textarea>
                    ...
                    <div>
                        <label for=""></label>
                        <div class="p-2 w-48">
                            <img id="showImage" src="{{ (!empty($latestNews->image))? url('upload/image-folder/'. $latestNews->image): url('upload/no-image.png') }}" width="200px" alt="">
                        </div>
                    </div>
